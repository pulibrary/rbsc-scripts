...
<xsl:stylesheet version="2.0" xmlns:ead="urn:isbn:1-931666-22-9"
    ...
    <xsl:template mode="single"
      ...
      <!--              <fo:block font-weight="bold" font-size="13pt" font-family="SansSerif"
                    ...
                    <!-- process child level -->
                    <fo:block font-weight="bold" font-family="SansSerif" font-size="13pt"
                        line-height="0.2in" text-align="start" span="none">
                            <fo:inline>
                                <xsl:choose>
                                    <xsl:when test="count(following-sibling::ead:unitdate)>1">
    ...
    <xsl:template mode="multi"
        ...
        <xsl:for-each select="$folderSeq">
            <fo:table-row height="1in" padding-bottom=".2in" padding-top=".2in">
                <fo:table-cell>
                    <fo:block margin-left="0.2in">
<!--                        <fo:block font-size="13pt" font-weight="bold" font-family="SansSerif"
                            line-height="0.2in" text-align="start" span="none">
                            <fo:inline>-->
